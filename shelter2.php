...
<section id="tabs" class="project-tab">
        <h1 class="abouthead my-4 text-white"> Animal Shelters</h1>
        <h6 style="color:blue">Below are the contact inforamtion of animal shelters according to different states. Please kindly contact them if you are facing some isses.</h6>
